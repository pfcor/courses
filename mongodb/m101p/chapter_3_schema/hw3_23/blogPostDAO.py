...
class BlogPostDAO:
    ...
    def insert_entry(self, title, post, tags_array, author):
        ...
        try:
            ...
            ins = self.posts.insert_one(post)
            print "Insertion complete - _id: ", ins.inserted_id
        except:
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            insert_comment = self.posts.update_one({'permalink': permalink}, {'$push': {'comments': comment}})
            return insert_comment.modified_count
